...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!email || !password) {
      setIsLoading(false)
      return toast.info("Give Both Fields !") 
    }
    axios
      .post(
  ...
  return (
    <div className="min-h-screen relative flex flex-col gap-3 items-center justify-center bg-gradient-to-br from-[#6366f1] to-[#8b5cf6] dark:bg-gradient-to-tr dark:from-[#051937] dark:to-[#A8EB12] px-4">
      <motion.div
